...
console.log(total);
// console.log(dhskddks); -> cauzeaza eroare

total = oneNumber + anotherNumber;
total = oneNumber - anotherNumber;
total = oneNumber * anotherNumber;
total = oneNumber / anotherNumber;
total = oneNumber % anotherNumber; // restul impartirii //modulo operator => restul impartirii
...
const fullName = 'Ana-Maria Oprea';
...
// la obiecte si array-uri de obicei ma intereseaza sa fie constante, pentru a nu le reatribui, ci doar sa le modific continutul
...
//let person = {
//     fullName: 'Ana' //!!! Error pt redeclarare
// };

const testString = 'Valoare de copiat';
const copiedString = testString;
